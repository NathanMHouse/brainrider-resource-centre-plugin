<?php
/**
 * Content none full-width template part for br resource centre plugin. Included by full-width archive.
 * 
 *
 */
?>

<div class="br-rc-no-results container">

	<?php
	// The filter terms
	?>
	<div class="row">
		<div class="br-rc-searched-terms col-md-8 col-md-offset-2">
			<?php 
